...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		FlxG.save.data.freeplayCuts = Cutscenes;
		...
		save.bind('controls', 'Definitive Corn Team'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.freeplayCuts != null) {
			Cutscenes =  FlxG.save.data.freeplayCuts;
		}

		var save:FlxSave = new FlxSave();
		save.bind('controls', 'Definitive Corn Team');
