...
class PlayMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['maize', 'probability', 'electronic', 'motocycle', 'fancy', 'pipebomb', 'fnaf is real', 'carnivore', 'spin dashin', 'agronomist', 'subversive', 'extras'];
	...
	override function create()
	{
		...
		menuBg = new FlxSprite(-80).loadGraphic(Paths.image('storyMenubg'));
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.frames = Paths.getSparrowAtlas('chad/menu_' + optionShit[i]);
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 24, 0, "1.0 Corn Engine", 12);
