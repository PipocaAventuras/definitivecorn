...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var stepperBPM:FlxUINumericStepper = new FlxUINumericStepper(10, 70, 1, 1, 1, 669, 1);
	...
	{
		if (song.toLowerCase() == 'probability' || song.toLowerCase() == 'rage')
		{
			startVideo('a');
			#if debug
