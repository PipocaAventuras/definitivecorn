...
function onUpdate()
	...
	doTweenAlpha('AlphaTween6', 'botplayTxt', 0, 0.1)
	doTweenAlpha('AlphaTween7', 'healthBarOverlay', 0, 0.1)
	...
	doTweenAlpha('AlphaTween6', 'botplayTxt', 1, 0.1)
	doTweenAlpha('AlphaTween7', 'healthBarOverlay', 1, 0.1)
